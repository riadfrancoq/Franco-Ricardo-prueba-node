...
import _productos_categorias from  "./productos_categorias.js";
import _productos_stocks from  "./productos_stocks.js";
...
export default function initModels(sequelize) {
  ...
  const productos_categorias = _productos_categorias.init(sequelize, DataTypes);
  const productos_stocks = _productos_stocks.init(sequelize, DataTypes);
  ...
  productos_categorias.belongsTo(categorias, { as: "id_categoria_categoria", foreignKey: "id_categoria"});
  categorias.hasMany(productos_categorias, { as: "productos_categoria", foreignKey: "id_categoria"});
  ...
  productos_categorias.belongsTo(productos, { as: "id_producto_producto", foreignKey: "id_producto"});
  productos.hasMany(productos_categorias, { as: "productos_categoria", foreignKey: "id_producto"});
  productos_stocks.belongsTo(productos, { as: "id_producto_producto", foreignKey: "id_producto"});
  productos.hasMany(productos_stocks, { as: "productos_stocks", foreignKey: "id_producto"});
  ...
  productos_stocks.belongsTo(tiendas, { as: "id_tienda_tienda", foreignKey: "id_tienda"});
  tiendas.hasMany(productos_stocks, { as: "productos_stocks", foreignKey: "id_tienda"});
